 ...
 *  ※既にあるclassやidにjsでstyleをくわえるため、load後に追加したclassなどに関しては適応されないみたいです。
 */
if((msie >= 6) && (msie <= 8)) {
...
/**
 * 〜 IE6
 * "jquery.belatedPNG.js" 透明pngを使えるようにします。
 * "jquery.exfixed.js.js" fixedを使えるようにします。
 */
if(Boolean(msie) && msie <= 6) {
	scriptCreate("js/jquery.belatedPNG.js");
	scriptCreate("js/jquery.exfixed.js");
	$(function() {
		$('body *').fixPng();
		$('#nav').exFixed();
	});
